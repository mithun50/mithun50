      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <a href={staticProfile.quilonix.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/30 hover:text-white transition-colors text-sm">
                <Globe className="w-4 h-4" />
                <span>Website</span>
              </a>
              <a href={staticProfile.quilonix.youtube} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/30 hover:text-white transition-colors text-sm">
                <Youtube className="w-4 h-4" />
                <span>YouTube</span>
              </a>
              <a href={staticProfile.quilonix.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/30 hover:text-white transition-colors text-sm">
              ...
              <a href={staticProfile.quilonix.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/30 hover:text-white transition-colors text-sm">
                <Linkedin className="w-4 h-4" />
                <span>LinkedIn</span>
              </a>
              <a href={staticProfile.quilonix.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/30 hover:text-white transition-colors text-sm">
                <Github className="w-4 h-4" />
                <span>GitHub</span>
              </a>
            </div>
