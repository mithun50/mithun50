        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/30 text-sm max-w-xs mb-4">
              Engineering Student @ {profile.education.shortName} | {profile.venture.role} @ {profile.venture.shortName}
            </p>
            {/* Social Links */}
            <div className="flex flex-wrap gap-3">
              <a href={profile.socials.github} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/[0.03] border border-white/[0.08] rounded-lg text-white/30 hover:text-white hover:border-white/20 transition-all" title="GitHub">
                <Github className="w-4 h-4" />
              </a>
              <a href={profile.socials.linkedin} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/[0.03] border border-white/[0.08] rounded-lg text-white/30 hover:text-white hover:border-white/20 transition-all" title="LinkedIn">
                <Linkedin className="w-4 h-4" />
              </a>
              <a href={profile.socials.npmjs} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/[0.03] border border-white/[0.08] rounded-lg text-white/30 hover:text-white hover:border-white/20 transition-all" title="npm">
              ...
              <a href={profile.socials.pypi} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/[0.03] border border-white/[0.08] rounded-lg text-white/30 hover:text-white hover:border-white/20 transition-all" title="PyPI">
          ...
          {/* NextGenX */}
          <div>
            <h4 className="text-white/50 text-xs font-mono uppercase tracking-widest mb-4">{profile.venture.shortName}</h4>
            <div className="flex flex-col gap-2">
              <a href={profile.nextgenx.youtube} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/30 hover:text-white transition-colors text-sm">
                <Youtube className="w-4 h-4" />
                <span>YouTube</span>
              </a>
              <a href={profile.nextgenx.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/30 hover:text-white transition-colors text-sm">
              ...
              <a href={profile.nextgenx.playstore} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/30 hover:text-white transition-colors text-sm">
